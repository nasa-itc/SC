/************************************************************************
**
** $Id: sc_rts009.c 1.2 2015/10/08 15:19:09EDT sstrege Exp  $
**
...
** Member renamed from sc_rts1.c to sc_rts009.c in project c:/MKSDATA/MKS-REPOSITORY/CFS-REPOSITORY/sc/fsw/tables/project.pj.
** Revision 1.4 2010/04/22 12:30:42ACT lwalling 
** Change default RTS table names from sc_rts1 to sc_rts009
...
{
    "RTS_Table009", "SC.RTS_TBL009", "SC Sample RTS_TBL009",
    "sc_rts009.tbl", (SC_RTS_BUFF_SIZE * sizeof(uint16))
};
...
*/
uint16 RTS_Table009[SC_RTS_BUFF_SIZE] =
{
